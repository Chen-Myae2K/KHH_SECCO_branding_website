...
const phrase1 =
  "Derived from high purity sand or quartz and processed by melting with soda ash, forming sodium silicate. This compound is then reacted with acid to precipitate silica, which is further refined into a gel like, porous structure";
...
const ProcessSection2 = () => {
  ...
  return (
    <section className="font-instrument tracking-tight text-black">
      <div className="grid grid-cols-1 lg:grid-cols-3 mb-16 md:mb-32">
        <div className="col-span-1 px-5 lg:px-10">
          <p className="text-5xl lg:text-6xl text-clean pb-5">01</p>
          <p className="lg:text-xl text-base leading-loose lg:leading-loose py-10">
            ...
            <p className="lg:my-10 my-5 leading-tight" ref={description}>
        ...
        <div className="col-span-2 mt-auto max-lg:py-5 max-lg:px-5">
            <img src={process1} className="w-full lg:ps-10" alt="" />
        </div>
      </div>
