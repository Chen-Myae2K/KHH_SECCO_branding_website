...
const phrase1 =
  "Sulfuric acid or another acid is added to the sodium silicate solution to precipitate the silica. The acid causes the silica to form a gel like structure, removing impurities and producing a more refined form of silica";
    ...
    <section className="font-instrument tracking-tight text-black">
      <div className="grid grid-cols-1 lg:grid-cols-3 mb-16  lg:mb-32">
        <div className="col-span-1 px-5 lg:px-10">
          <p className="text-5xl lg:text-6xl text-clean pb-5">03</p>
        ...
        <div className="col-span-2 mt-auto max-lg:py-5 max-lg:px-5">
          <img src={process3} className="w-full lg:ps-10" alt="" />
        </div>
      </div>
    </section>
  );
