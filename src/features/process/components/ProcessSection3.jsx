...
const phrase1 =
  "Soda ash is mixed with silica in a specific ratio and heated at high temperatures to react with silica, forming sodium silicate (Na₂SiO₃). This sodium silicate solution is essential for creating silica gel";

const ProcessSection3 = () => {
    ...
    <section className="font-instrument tracking-tight text-black">
      <div className="grid grid-cols-1 lg:grid-cols-3 mb-16 lg:mb-32">
        <div className="col-span-1 px-5 lg:px-10">
          <p className="text-5xl lg:text-6xl text-clean pb-5">02</p>
        ...
        <div className="col-span-2 mt-auto max-lg:py-5 max-lg:px-5">
          <img src={process2} className="w-full lg:ps-10" alt="" />
        </div>
      </div>
    </section>
  );
...
export default ProcessSection3;
